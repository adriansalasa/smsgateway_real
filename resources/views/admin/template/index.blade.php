      ...
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <a href="{{ route('admin.add-template') }}" class="btn btn-sm btn-info mr-2"><i class="fa fa-pencil-alt"></i> Tambah Template</a>
                    ...
                    <tr>
                      ...
                      <td class="p-0 text-center">
                        ...
                        <div class="custom-checkbox custom-control">
                          ...
                          <input type="checkbox" data-checkboxes="mygroup" class="data-check custom-control-input" id="checkbox-{{ $loop->iteration }}" value='{{$item->tid}}'>
                      ...
                      <td>
                          ...
                          <form class="delete" action="template/{{ $item->tid }}" method="POST" class="d-inline">

                            @method('delete')

                            @csrf

                        <a href="{{url('pesan/template/edit/'.$item->tid)}}" class="text-success" title="Edit"><i class="fa fa-edit" ></i></a>
        ...
        $("#bulk_delete_contact").click(function() {
...

          {
...

              {
                ...
                url:"{{ route('admin.template_deletes') }}",
...

                {
                  ...
                  window.location = "{{ route('admin.template') }}";
