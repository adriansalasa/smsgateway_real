                ...
                <div class="table-responsive">
                  ...
                  <table class="table table-striped">
                    ...
                    <tr>
                      ...
                      <th style="width:16%">Tanggal Input</th>
                    ...
                    <tr>
                      ...
                      <td>
                        {{Carbon\Carbon::parse($item->datetime_entry)->addHour('7')}}
                      </td>
                      ...
                      <td>
                           ...
                           <a href="#">Sebanyak {{$item->queue_count}} nomor</a>

                      </td>

                      <td>

                        {{Carbon\Carbon::parse($item->datetime_scheduled)->addHour('7')}}
                      ...
                      <td>
                          ...
                          <form class="delete" action="/pesan/inbox/{{ $item->id }}" method="POST" class="d-inline">

                            @method('delete')

                            @csrf

                        <a href="/pesan/{{ $item->id }}/replay" class="text-success" title="Balas"><i class="fa fa-reply" ></i></a>
