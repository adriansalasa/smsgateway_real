                ...
                <form method="POST" action="{{ route('admin.send_sms') }}">
                    ...
                    @csrf
                        ...
                        <div class="form-row">
                            ...
                            <input type="hidden" name="p_num_text" class="@error('p_num_text') is-invalid @enderror" id=msg_combo_sendto style="width: 100%" placeholder="Nomor Tujuan">
                            <span class="text-secondary">Ketik pagar untuk memunculkan group. contoh: #GMT01</span>

                            <div class="invalid-feedback">

                                @error('p_num_text') {{ $message}} @enderror
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="inputTemplate" class="form-control" onchange="getvaltemplate(this);">
                                    ...
                                    @foreach ($template as $item)
                                        ...
                                        <option value="{{ $item->t_text }}">{{ $item->t_title }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="height: 150px;"  name="message" id="message_draft" rows="10" cols="45" class="form-control @error('message') is-invalid @enderror" placeholder="Tulis Pesan"></textarea>
...
<script type="text/javascript" src="{{ asset('assets/js/combobox/select2.min.js') }}"></script>

<script type="text/javascript" src="{{ URL::to('/') }}/assets/js/combobox/select2_locale_id.js"></script>
